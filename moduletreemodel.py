...
class MainWindow(QtGui.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        model.rootItem.child(0).setData(1, "row 1 column 2")
        model.rootItem.child(1).setData(0, "row 2 column 1")
        model.rootItem.child(1).setData(1, "row 2 column 2")
        model.rootItem.child(0).insertChildren(0,1, model.rootItem.columnCount())
        model.rootItem.child(1).insertChildren(0,1, model.rootItem.columnCount())
        model.rootItem.child(0).child(0).setData(0, "row 1b column 1")
        model.rootItem.child(1).child(0).setData(0, "row 2b column 1")
